...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-bd0b9049.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-ac3f02f3.mjs').then((m) => m.default || m)
  },
  {
    name: "line-_lineId",
    path: "/line/_lineId",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-7a84a65d.mjs').then((m) => m.default || m)
  },
  {
    name: "line",
    path: "/line",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-c80a2e3c.mjs').then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-bc7538a2.mjs').then((m) => m.default || m)
  },
  {
    name: "station",
    path: "/station",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-895b93fd.mjs').then((m) => m.default || m)
  }
];
...
const namedMiddleware = {
  "redirect-to-top": () => import('./_nuxt/redirectToTop-1d883df8.mjs')
};
...
const getObjectById_MMRzOQSaKd = /* @__PURE__ */ defineNuxtPlugin(() => {
  return {
    provide: {
...
const rootPath_RFIpRsBPzh = /* @__PURE__ */ defineNuxtPlugin(() => {
  return {
    provide: {
      rootPath: (url) => {
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-404-cf0a9f94.mjs').then((r) => r.default || r));
...
export { _export_sfc as _, useNuxtApp as a, useRouter as b, createError as c, entry$1 as default, navigateTo as n, useHead as u };
